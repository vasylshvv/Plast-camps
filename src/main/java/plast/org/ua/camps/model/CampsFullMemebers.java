...
public class CampsFullMemebers {
	...
	public CampsFullMemebers() {
		super();
		// TODO Auto-generated constructor stub
	}
	public CampsFullMemebers(String stupin, String name, String kurin, Date birthday, String stanytsya, String kvstupin,
			List<CampQualificationMember> qualification, String vyshkolycamp, String email, String phone) {
		this.stupin = stupin;
		this.name = name;
		this.kurin = kurin;
		this.birthday = birthday;
